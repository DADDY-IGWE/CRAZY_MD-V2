...
cmd({
  ...
  try {
    ...
    const rawVersionUrl = 'https://raw.githubusercontent.com/LORD-IGWE/CRAZY-MD-V1/main/DATABASE/version.json';
...
*ᴜsᴇ .ᴜᴘᴅᴀᴛᴇ ᴛᴏ ᴜᴘᴅᴀᴛᴇ ᴄʀᴀᴢʏ ᴍᴅ.*`;
    ...
    await conn.sendMessage(from, {
      image: { url: 'https://files.catbox.moe/giab52.jpeg' },
