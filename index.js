...
const sessdata = config.SESSION_ID.replace("CRAZY-OFC~", '');
const filer = File.fromURL(`https://mega.nz/file/${sessdata}`)
filer.download((err, data) => {
if(err) throw err
fs.writeFile(__dirname + '/auth_info_baileys/creds.json', data, () => {
console.log("SESSION SUCCESFULLY COMPLETED ✅")
})})}
...
console.log("CONNECTING CRAZY MD⚙️...");
...
let up = `*╭──────────────●●►*
> ʜɪ ᴄʀᴀᴢʏ sᴜᴄᴄᴇsғᴜʟʟʏ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴇɴᴊᴏʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ sᴇᴇ ᴛʜᴇ ᴀʟʟ ᴍᴇɴᴜ ʟɪsᴛ ᥫᩣ

> ᴊᴏɪɴ ᴍʏ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴍᴏʀᴇ ᴜᴘᴅᴀᴛᴇ ᴏғ ᴄʀᴀᴢʏ ᴍᴅ 🍃

↬ *https://whatsapp.com/channel/0029Vb4QhPj4NVipeOtyo02n*

*╭⊱✰ 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡 ✰⊱╮*
*│↬ - 🍃 ʙᴏᴛ ɴᴀᴍᴇ:* *ᴄʀᴀᴢʏ ᴍᴅ*
*│↬ - 📃 ɪɴғᴏʀᴍᴀᴛɪᴏɴ:* *ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ*
*│↬  - 🦄 ᴅᴇᴠ:* *CRAZY DEV*

ᴅᴏɴ'ᴛ ғᴏʀɢᴇᴛ ᴛᴏ ғᴏʀᴋ ᴀɴᴅ sᴛᴀʀ🌟 ᴍʏ ʀᴇᴘᴏsɪᴛᴏʀʏ\n\n*ᴘʀᴇғɪx: 〘 ${prefix}〙*\n\nᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴄʀᴀᴢʏ ᴅᴇᴠ

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/mg60m4.jpeg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("24107730123")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("24177772865")){
if(isReact) return
m.react("👑")
}
